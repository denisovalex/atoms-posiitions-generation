...
namespace AtomsPositionsGenerationLib.Lattice
{
	public class FCCLattice: ILattice
	{
		...
		public void Create()
		{
			...
			Particles.AddRange(CreateParticlessOfCertainType(0.5, 0.5, 0));
			Particles.AddRange(CreateParticlessOfCertainType(0, 0.5, 0.5));
			Particles.AddRange(CreateParticlessOfCertainType(0.5, 0, 0.5));
		}
